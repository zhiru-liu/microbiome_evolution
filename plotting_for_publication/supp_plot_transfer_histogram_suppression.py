...
species = ['Bacteroides_vulgatus_57955', 'Alistipes_shahii_62199', 'Eubacterium_rectale_56927']
...
fig.savefig(os.path.join(config.figure_directory, 'transfer_histo_suppresions.pdf'), bbox_inches='tight')
