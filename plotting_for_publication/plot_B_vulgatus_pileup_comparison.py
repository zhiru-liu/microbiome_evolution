...
between_cumu_runs, within_cumu_runs = plot_pileup_mirror.load_data_and_plot_mirror(
    within_clade_path, between_clade_path, ax, threshold_lens=thresholds, ind_to_plot=[0, 1, 2], ylim=0.35)
...
fig.savefig(os.path.join(config.analysis_directory, 'misc', 'B_vulgatus_pileup_with_highlight.pdf'), bbox_inches='tight')