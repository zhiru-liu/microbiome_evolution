...
y1 = full_df[full_df['divergences'] >= 0.03]['lengths'] * config.second_pass_block_size
y2 = full_df[full_df['divergences'] < 0.03]['lengths'] * config.second_pass_block_size
...
fig.savefig(os.path.join(config.figure_directory, "A_shahii_transfer_length.pdf"), bbox_inches='tight')
