...
pylab.savefig('%s/%s_kegg_histogram_high_vs_low_pis_prevalence_0.9.png' % (
...
pylab.savefig('%s/%s_pi_kegg_histogram_high_vs_low_pis_prevalence_0.5.png' % (
    parse_midas_data.analysis_directory, species_name), bbox_inches='tight')
...
pylab.savefig('%s/%s_pi_kegg_histogram_high_vs_low_pis_prevalence_0.1.png' % (
    parse_midas_data.analysis_directory, species_name), bbox_inches='tight')
