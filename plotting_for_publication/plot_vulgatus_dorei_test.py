...
from utils import diversity_utils, clade_utils, gene_diversity_utils, stats_utils
...
divergence_fig.savefig('%s/supplemental_divergence_distribution%s.pdf' % (
    parse_midas_data.analysis_directory, other_species_str), bbox_inches='tight')
