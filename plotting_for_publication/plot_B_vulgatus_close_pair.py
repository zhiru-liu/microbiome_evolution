...
s1 = ct_ax.scatter(T_approxs, within_counts, s=2, c=plt_colors[0], label='Within clade transfers')
s2 = ct_ax.scatter(T_approxs, -np.array(between_counts), s=2, c=plt_colors[1], label='Between clade transfers')
ct_ax.plot(T_approxs, np.zeros(T_approxs.shape), 'k-')

# ct_ax.set_xlim([0, 3e-4])
