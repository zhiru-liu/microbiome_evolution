...
import config
from utils import close_pair_utils, diversity_utils, snp_data_utils, typical_pair_utils
...
axes[1].legend()
plt.tight_layout()
fig.savefig(os.path.join(config.figure_directory, 'supp', 'S12_supp_downsampling_Ap.pdf'), dpi=600)