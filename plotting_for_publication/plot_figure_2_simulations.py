...
from utils import diversity_utils, clade_utils, figure_utils, gene_diversity_utils, stats_utils
...
examples = ["Bacteroides_vulgatus_57955",  "Bacteroides_fragilis_54507"]
...
for example_idx in xrange(0,len(examples)):
    ...
    figure_utils.get_abbreviated_species_name(examples[example_idx]), num_random_pairs))
