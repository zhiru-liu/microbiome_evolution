...
import sys
import numpy
from utils import diversity_utils, sample_utils, stats_utils
...
for species_name in good_species_list:
    ...
    from plos_bio_scripts import calculate_private_snvs, calculate_temporal_changes, calculate_substitution_rates
