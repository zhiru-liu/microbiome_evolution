...
pylab.suptitle("LD among rare SNPs (MAF < 0.05)")
pylab.xlim([1,1e04])
pylab.ylim([1e-02,1])
variant_type='1D'
...
pylab.savefig('%s/%s_intragene_ld_syn_nonsyn_rare.pdf' % (parse_midas_data.analysis_directory, species_name), bbox_inches='tight')
pylab.savefig('%s/%s_intragene_ld_syn_nonsyn_rare.png' % (parse_midas_data.analysis_directory, species_name), bbox_inches='tight', dpi=300)
