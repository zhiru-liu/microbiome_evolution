...
from utils import diversity_utils, stats_utils, species_phylogeny_utils
from parsers import parse_HMP_data, parse_midas_data
from plos_bio_scripts import calculate_singletons, calculate_temporal_changes
...
for species_name in good_species_list:
    ...
    snp_samples = haploid_samples[
        parse_midas_data.calculate_unique_samples(subject_sample_map, sample_list=haploid_samples)]
