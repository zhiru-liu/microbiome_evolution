...
pylab.savefig('%s/%s_fixation_vs_pi_%0.1f_metaphlan2_genes.pdf' % (
    parse_midas_data.analysis_directory, species_name, min_change), bbox_inches='tight')
pylab.savefig('%s/%s_fixation_vs_pi_%0.1f_metaphlan2_genes.png' % (
    parse_midas_data.analysis_directory, species_name, min_change), bbox_inches='tight', dpi=300)
