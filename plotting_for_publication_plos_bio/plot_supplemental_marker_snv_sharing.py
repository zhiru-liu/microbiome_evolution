...
from utils import diversity_utils, sample_utils, stats_utils, species_phylogeny_utils
from parsers import parse_midas_data

import matplotlib as mpl
import matplotlib.pyplot as plt
import matplotlib.gridspec as gridspec
from numpy.random import poisson, binomial, choice, hypergeometric
...
for species_name in good_species_list:
    ...
    snp_samples = haploid_samples[
        sample_utils.calculate_unique_samples(subject_sample_map, sample_list=haploid_samples)]
...
within_sharing_axis.set_ylabel('Fraction timepoint pairs $\geq p$')
...
within_sharing_axis.step(xs,ns*1.0/ns[0],'-',label='Twin replacements',zorder=3,color='#8856a7')
