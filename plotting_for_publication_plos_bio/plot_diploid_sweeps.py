...
from utils import diversity_utils, figure_utils
from parsers import parse_HMP_data, parse_midas_data
from plos_bio_scripts import calculate_temporal_changes
...
for species_name in good_species_list:
    ...
    for pair_idx in xrange(0,len(diploid_pair_map[species_name])):
        ...
        figure_utils.get_abbreviated_species_name(species_name), sample_i, sample_j))
